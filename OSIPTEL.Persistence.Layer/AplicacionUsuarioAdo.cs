    ...
    public class AplicacionUsuarioAdo : IAplicacionUsuarioAdo
    {
        ...
        public async Task<string> GetValidUsuario(UsuarioValid model)
        {
            ...
            try
            {
                ...
                {
                    using (OracleCommand cmd = new OracleCommand("ACC_PKG_ACCESO.SP_VALIDAR_USUARIO", context))
                    {
                        try
                        {
        ...
        public async Task<Usuario> GetDatUsuario(UsuarioValid model)
        {
            ...
            try
            {
                ...
                using (context = new OracleConnection(_dbConnection.ConnectionString))
                {
                    using (OracleCommand cmd = new OracleCommand("ACC_PKG_ACCESO.SP_OBTENER_USUARIO", context))
                    {
                        try
                        {
                            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<List<Perfil>> GetDatPerfil(UsuarioValid model)
        {
            ...
            try
            {
                ...
                using (context = new OracleConnection(_dbConnection.ConnectionString))
                {
                    using (OracleCommand cmd = new OracleCommand("ACC_PKG_ACCESO.SP_OBTENER_PERFIL_X_USUARIO", context))
                    {
                        try
                        {
                            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<string> GetCadenaLDAP(DominioValid model)
        {
            ...
            try
            {
                using (context = new OracleConnection(_dbConnection.ConnectionString))
                {
                    using (OracleCommand cmd = new OracleCommand("ACC_PKG_GLOBAL.SP_OBTENER_GLOBAL", context))
                    {
                        try
                        {
                            cmd.CommandType = CommandType.StoredProcedure;
